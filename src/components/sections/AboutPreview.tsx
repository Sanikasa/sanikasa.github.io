...
const TimelineStep = ({
  ...
  return <motion.div ref={stepRef} style={{
    opacity,
    scale
      ...
      <div className="hidden md:flex flex-col items-center">
        ...
        {/* Connecting line */}
        {!isLast && <div className="relative w-0.5 h-32 bg-border/50 mt-4">
            <motion.div style={{
          height: lineHeight
...
export const AboutPreview = () => {
  ...
  return <section ref={containerRef} className="relative py-24 md:py-32 bg-gradient-to-b from-background via-card to-background overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16 md:mb-24">
          ...
          delay: 0.2
        }} className="text-muted-foreground max-w-2xl mx-auto"> I specialize in translating market information into strategic decisions, focused on creating long-term value through disciplined analysis and evidence-based modeling</motion.p>
        </div>

        {/* Timeline */}
        <div className="max-w-4xl mx-auto pl-14 md:pl-0 space-y-12 md:space-y-0">
          {journeySteps.map((step, index) => <TimelineStep key={step.id} step={step} index={index} isLast={index === journeySteps.length - 1} />)}
        </div>
