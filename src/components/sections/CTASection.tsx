...
export const CTASection = () => {
  return (
    <section className="py-24 md:py-32 relative overflow-hidden">
      ...
      <DataMatrixBackground className="opacity-30" />
      ...
      <motion.div
        ...
        className="absolute bottom-0 left-0 w-[500px] h-[500px] rounded-full bg-purple/20 blur-3xl"
      />
      <motion.div
        animate={{ scale: [1.2, 1, 1.2], opacity: [0.1, 0.2, 0.1] }}
        transition={{ duration: 12, repeat: Infinity, delay: 1 }}
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full bg-emerald/10 blur-3xl"
      />
